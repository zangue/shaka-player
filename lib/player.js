 ...
 * @description Fired when the player has buffered all media segments up to the
 *   end of the presentation duration.
 * @property {string} type
 *   'bufferedtoend'
 * @exportDoc
 */
